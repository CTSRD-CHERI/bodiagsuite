...
select count(*) from testcases T,uno U where 
    T.name=U.name and T.asynchrony=0 and U.ok=1;
select count(*) from testcases where asynchrony=1;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.asynchrony=1 and U.ok=1;
select count(*) from testcases where asynchrony=2;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.asynchrony=2 and U.ok=1;
select count(*) from testcases where asynchrony=3;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.asynchrony=3 and U.ok=1;

select count(*) from testcases where taint=0;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.taint=0 and U.ok=1;
select count(*) from testcases where taint=1;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.taint=1 and U.ok=1;
select count(*) from testcases where taint=2;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.taint=2 and U.ok=1;
select count(*) from testcases where taint=3;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.taint=3 and U.ok=1;
select count(*) from testcases where taint=5;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.taint=5 and U.ok=1;

select count(*) from testcases where runtimeenvdep=0;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.runtimeenvdep=0 and U.ok=1;
select count(*) from testcases where runtimeenvdep=1;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.runtimeenvdep=1 and U.ok=1;

select count(*) from testcases where continuousdiscrete=0;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.continuousdiscrete=0 and U.ok=1;
select count(*) from testcases where continuousdiscrete=1;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.continuousdiscrete=1 and U.ok=1;

select count(*) from testcases where signedness=0;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.signedness=0 and U.ok=1;
select count(*) from testcases where signedness=1;
select count(*) from testcases T,uno U where 
    T.name=U.name and T.signedness=1 and U.ok=1;
